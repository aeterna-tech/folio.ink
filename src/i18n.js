	...
	en: {
		translation: {
			...
			logEditor: {
				...
				exportPresetLabel: 'Export template',
				presetLabel_standup: 'Standup',
				presetLabel_sprint_report: 'Report',
				presetLabel_brag_doc: 'Brag doc',
				artifactCopyTooltip: 'Copy as Markdown',
				artifactDownloadTooltip: 'Download as .md',
				artifactCopyError: "Couldn't copy to clipboard",
				copied: 'Copied!',
				exportButton: 'Export raw .md',
				exportTooltip: 'Download all raw project entries as a Markdown file',
				exporting: 'Exporting…',
				exportError: "Couldn't export the project",
			},
			stats: {
				header: 'Stats',
				backendRequired:
	...
	ru: {
		translation: {
			...
			logEditor: {
				...
				toolbarBoldPlaceholder: 'жирный текст',
				toolbarItalicPlaceholder: 'курсив',
				toolbarHeadingPlaceholder: 'Заголовок',
				toolbarListPlaceholder: 'Пункт списка',
				exportPresetLabel: 'Шаблон экспорта',
				presetLabel_standup: 'Стендап',
				presetLabel_sprint_report: 'Отчёт',
				presetLabel_brag_doc: 'Brag-doc',
				artifactCopyTooltip: 'Скопировать как Markdown',
				artifactDownloadTooltip: 'Скачать как .md',
				artifactCopyError: 'Не удалось скопировать в буфер обмена',
				copied: 'Скопировано!',
				exportButton: 'Экспорт .md (сырые записи)',
				exportTooltip: 'Скачать все записи проекта как есть, в виде Markdown-файла',
				exporting: 'Экспорт…',
				exportError: 'Не удалось экспортировать проект',
			},
			stats: {
				header: 'Статистика',
				backendRequired:
